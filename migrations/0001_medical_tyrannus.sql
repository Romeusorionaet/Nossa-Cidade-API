...
--> statement-breakpoint
CREATE TABLE "product_custom_tags" (
	"id" text PRIMARY KEY NOT NULL,
	"business_point_id" text NOT NULL,
	"tag" varchar(25) NOT NULL
);
...
CREATE TABLE "business_point_drafts" (
	...
	"censorship" boolean DEFAULT false,
	"highlight" varchar(100),
	CONSTRAINT "business_point_drafts_business_point_id_unique" UNIQUE("business_point_id"),
...
ALTER TABLE "product_custom_tags" ADD CONSTRAINT "product_custom_tags_business_point_id_products_id_fk" FOREIGN KEY ("business_point_id") REFERENCES "public"."products"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "product_images" ADD CONSTRAINT "product_images_product_id_products_id_fk" FOREIGN KEY ("product_id") REFERENCES "public"."products"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "products" ADD CONSTRAINT "products_business_point_id_business_points_id_fk" FOREIGN KEY ("business_point_id") REFERENCES "public"."business_points"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
