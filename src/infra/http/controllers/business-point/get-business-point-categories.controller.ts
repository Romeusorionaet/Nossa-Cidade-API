import type { GetBusinessPointCategoriesUseCase } from "src/domain/our-city/application/use-cases/business-point/get-business-point-categories";
...
export class GetBusinessPointCategoriesController {
	constructor(
		private getBusinessPointCategoriesUseCase: GetBusinessPointCategoriesUseCase,
	) {}
